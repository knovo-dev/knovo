...
1. Llama 3 for broad general-purpose assistant behavior
2. Mistral for compact instruction-following setups
3. Gemma for lightweight evaluation and deployment paths
4. Phi for small-model experiments and constrained environments
...
The model library page for Llama 3 shows the standard command:
